...
sender_data = str(st.text_area("Enter Sender Data")).encode()


# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_data = str(st.text_area("Enter Receiver Data")).encode()

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_data = str(st.text_area("Amount Data")).encode()
